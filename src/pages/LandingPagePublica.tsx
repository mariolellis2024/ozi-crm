    ...
    <>
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media(max-width:768px) { .hero-layout { grid-template-columns: 1fr; gap: 16px; } .hero-img-col { order: -1; } .hero-img { height: auto; max-height: 320px; } .badge { margin-bottom: 12px; } .cg,.mg { grid-template-columns: 1fr; } .ar { grid-template-columns: 1fr; } .sr { gap: 32px; } .pc { padding: 32px 28px; } .bb { padding: 28px 22px; } .bb-layout.has-img { grid-template-columns: 1fr; } .bb-layout.has-img .bb-img-wrap { order: -1; } .fc { flex-direction: column; gap: 8px; padding: 10px 18px; } .hero { padding: 20px 0 32px; } .c { padding: 0 20px; } }
      `}</style>
