...
import { GraduationCap, User, LogOut, BookOpen, Home, ChevronLeft, ChevronRight, DoorClosed, Calendar } from 'lucide-react';
...
export function Layout({ children }: LayoutProps) {
  ...
  const menuItems = [
    ...
    { icon: Calendar, label: 'Ocupação', path: '/ocupacao' },
